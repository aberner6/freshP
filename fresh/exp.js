...
//     .domain(inputs)
//     .rangePoints([xStart, xEnd]);
// var yO = d3.scale.ordinal()
//     .domain(outputs)
//     .rangePoints([xStart, xEnd]);
// var yP = d3.scale.ordinal()
//     .domain(programming)
//     .rangePoints([xStart, xEnd]);
// var yG = d3.scale.ordinal()
//     .domain(games)
//     .rangePoints([xStart, xEnd]);
...
// enteringDay
//   .selectAll(".textDescrip")
//   .data(interactionTypes)
//   .enter()
//   .append("text")
//   .classed("textDescrip", true)
//   .attr("x",-40)
//   .attr("y", function(d,i){
//     return y(d);
//   })
...
//maybe for the softwware connection that should just be a filled in square if it has been established in software
  ...
  insideDay.append('circle')
    .attr("class",function(d){
      return "fromType"+d.from+"and mod"+d.mod;
    })
    .attr("opacity",opacityCirc)
    .attr("cx",function(d){
      return 10;
      // return //something with the time...
    })
    .attr("cy",function(d){
